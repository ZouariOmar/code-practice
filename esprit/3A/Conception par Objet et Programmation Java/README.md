...
This guide details the commands necessary to execute the provided solutions for **Prosit 1 --> 5**. These exercises focus on beginning Java application development centered around a `ZooManagement` system.
