...
This guide details the commands necessary to execute the provided solutions for **Prosit 1 --> 9**. These exercises focus on beginning Java application development.
